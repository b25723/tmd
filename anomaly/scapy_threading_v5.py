...
anomaly= [
[["udp_flood"],["sendp(Ether()/IP(src='{0}',dst='{1}')/UDP(sport=100,dport=100),iface='{2}',count={3})".format(srchost,dsthost,inf,pkts)]],
[["tcp_port_scan"],["sendp(Ether()/IP(src='{0}',dst='{1}')/TCP(flags='F',dport=(100,{3})),iface='{2}')".format(srchost,dsthost,inf,100+pkts)]],
[["udp_port_scan"],["sendp(Ether()/IP(src='{0}',dst='{1}')/UDP(sport=(100,{3}),dport=100),iface='{2}')".format(srchost,dsthost,inf,100+pkts)]],
[["ip_sweep"],["sendp(Ether()/IP(src='{0}',dst='{1}/27')/TCP(),iface='{2}')".format(srchost,dsthost,inf)]],
[["tcp_null_scan"],["sendp(Ether()/IP(src='{0}',dst='{1}')/TCP(dport=(1,{3}),flags='',window=1024),iface='{2}')".format(srchost,dsthost,inf,1+pkts)]],
[["tcp_port_syn_scan\\flood"],["sendp(Ether()/IP(src='{0}',dst='{1}')/TCP(flags='S',seq=1,dport=(100,{3})),iface='{2}')".format(srchost,dsthost,inf,100+pkts)]],
[["tcp_port_xmas_scan"],["sendp(Ether()/IP(src='{0}',dst='{1}')/TCP(flags='PFU',seq=1,dport=(100,{3})),iface='{2}')".format(srchost,dsthost,inf,100+pkts)]],
[["tcp_syn_flood"],["sendp(Ether()/IP(src='{0}',dst='{1}')/TCP(sport=(1,{3}),dport=80),iface='{2}')".format(srchost,dsthost,inf,1+pkts)]],
[["icmp_flood"],["sendp(Ether()/IP(src='{0}',dst='{1}')/ICMP(),iface='{2}',count={3})".format(srchost,dsthost,inf,pkts)]],
[["tcp_port_fin scan"],["sendp(Ether()/IP(src='{0}',dst='{1}')/TCP(flags='F',seq=1,dport=(100,{3})),iface='{2}')".format(srchost,dsthost,inf,100+pkts)]],
[["igmp_flood"],["sendp(Ether()/IP(src='{0}',dst='{1}')/IGMP(),iface='{2}',count={3})".format(srchost,dsthost,inf,pkts)]],
