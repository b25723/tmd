...
#a=requests.get(URL+IPS+'/packages',cookies={'sid':req.json()['sid']},verify=False)
#a=requests.get(URL+IPS+'/1',cookies={'sid':req.json()['sid']},verify=False)
#print a
...
def add_ips(counter=3):
    ...
    for i in range(1,counter+1):
        ...
        s=requests.post(URL+IPS+'/pending',cookies={'sid':req.json()['sid']},verify=False)
#        print s.status_code
...
def copy_ips(counter=3):
    ...
    for i in range(1,counter+1):
        sig['ipProfile']['name']=sig['ipProfile']['name']+'([0])'.format(str(i))
        s=requests.get(URL+IPS+'/1',cookies={'sid':req.json()['sid']},verify=False)
        mtag={'MTag': str(s.headers['mtag'])}
        s=requests.post(URL+IPS+'1/duplicate',json=sig,cookies={'sid':req.json()['sid']},headers=mtag,verify=False)
        s=requests.post(URL+IPS+'/pending',cookies={'sid':req.json()['sid']},verify=False)
        print s.status_code
...
def del_node(node=1):
    #s=requests.delete(URL+'/rest/nodes?nodes=1',cookies={'sid':req.json()['sid']},verify=False)
    s=requests.delete(URL+'/rest/nodes/'+str(node),cookies={'sid':req.json()['sid']},verify=False)
    print s.status_code
    print s.content
    #print nodet['node']
...
def add_account(counter=1):
    for i in range(1,counter+1):
        ...
        s=requests.post(URL+'/rest/admins',json=acct,cookies={'sid':req.json()['sid']},verify=False)
        print s.status_code
        print s.content
        print acct
        #print nodet['node']
